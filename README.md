...
Internet-Draft         DNSSEC Trusted Key Sentinel          October 2018
   ...
   to the consideration of local collisions and the reservation of
...
Internet-Draft         DNSSEC Trusted Key Sentinel          October 2018
   ...
   o  A query name containing the left-most label "root-key-sentinel-
      not-ta-<key-tag>".  This also corresponds to a validly-signed
   ...
   o  A query name that is signed with a DNSSEC signature that cannot be
      ...
      when, for example, an RRset associated with a zone that is not
